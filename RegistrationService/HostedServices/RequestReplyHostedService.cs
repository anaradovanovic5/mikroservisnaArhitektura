        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.ReceivedAsync += async (_, ea) =>
            {
                ...
                try
                {
                    ...
                    Console.WriteLine($"[Request-Reply] Zahtev za DogadjajId={dogadjajId}, saljem odgovor: {odgovor}");
                ...
                {
                    Console.WriteLine($"[Request-Reply] Greska: {ex.Message}");
            ...
            Console.WriteLine("RegistrationService: slusa Request-Reply red.");
